...
class Input
{
    ...
    {
        /* 
        InputMapping["Up"] = [ConsoleKey.W , ConsoleKey.UpArrow];
        InputMapping["Down"] = [ConsoleKey.S, ConsoleKey.DownArrow];
        InputMapping["Left"] = [ConsoleKey.A, ConsoleKey.LeftArrow];
        InputMapping["Right"] = [ConsoleKey.D, ConsoleKey.RightArrow];
        */
        ...
        InputMapping["Quit"] = new KeyList(ConsoleKey.Q, ConsoleKey.Escape);
